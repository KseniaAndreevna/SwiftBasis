...
//  Lesson8
//
//  Created by Ksusha on 31.01.2021.
//
...
//
// Тесты для задания урока №7


// Задание 1
enum TeapotError: Error, Equatable {
    case noWater
    case switchedOff
    case notInSocket
...
//    }
    ...
    func open() throws -> Bool {
        guard !isOpen else {
            throw TeapotError.lidAlreadyOpen
        }
    ...
    func close() throws -> Bool  {
        guard isOpen else {
            throw TeapotError.lidAlreadyClosed
        }
