...
var sportCar1 = SportCar(brand: carBrand.BMW, model: "XSR", numbers: "FR777K", gearboxType: gearboxType.manual, color: carColor.black, year: 2019, luggageVolume: 100.45, bodyVolume: 1000, luggageState: luggageState.empty, filledLuggageVolume: 99.55, windowState: windowState.open, engineState: engineState.started)
